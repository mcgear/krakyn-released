...
import BaseCard from "../../BaseCard"; // plasmic-import: 7T6MSFN1HWiZ/component
...
import * as sty from "./PlasmicPlan.module.css"; // plasmic-import: j_CnXNJ8FXsz/css
        ...
        >
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              ...
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet___1Df95)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__mgUql)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__z6Yd)}
                />
              </p.Stack>
            ),
          ...
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__kSlH7)}
