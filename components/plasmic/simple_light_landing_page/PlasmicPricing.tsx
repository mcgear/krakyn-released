...
import Plan from "../../Plan"; // plasmic-import: j_CnXNJ8FXsz/component
...
import Faq from "../../Faq"; // plasmic-import: Kltb72jaTMx5/component
...
import * as sty from "./PlasmicPricing.module.css"; // plasmic-import: atChbM2I9uWZ/css
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Plan
                  className={classNames("__wab_instance", sty.plan___72LXe)}
                  price={
                    <div
                      className={classNames(
                        defaultcss.all,
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__mhueK)}
              ...
              >
                <Plan
                  className={classNames("__wab_instance", sty.plan__xu5SR)}
                  description={
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__oMKhe)}
                    color={"blue" as const}
                  >
                    {"Get started"}
                  </Button>
              ...
              >
                <Plan
                  className={classNames("__wab_instance", sty.plan___1912B)}
                  name={"Enterprise"}
                  price={
                    <div
                      className={classNames(
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__qnAv)}
                    color={"outlineBlue" as const}
                  >
                    {"Get started"}
                  </Button>
          ...
          >
            ...
            >
              <Faq
                className={classNames("__wab_instance", sty.faq__jyk3G)}
                slot={
              ...
              <Faq
                className={classNames("__wab_instance", sty.faq__lSmLx)}
                slot={
                  "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                }
              >
              ...
              <Faq
                className={classNames("__wab_instance", sty.faq__gh89M)}
                slot={
                  "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                }
              >
