...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: 7T6MSFN1HWiZ/css
    ...
    >
      <div
        className={classNames(
          ...
          sty.freeBox__dLcvf,
          {
            [sty.freeBox__long__dLcvfzOGev]: hasVariant(
              variants,
              "long",
              "long"
            )
      ...
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(
            ...
            sty.freeBox__d9Nxt,
            {
              [sty.freeBox__long__d9NxtzOGev]: hasVariant(
                variants,
                "long",
                "long"
              )
