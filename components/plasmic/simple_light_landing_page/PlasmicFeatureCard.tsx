...
import * as sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: _Z_r7dqFAmk/css
    ...
    >
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(
            ...
            sty.freeBox___2IkRv,
            {
              [sty.freeBox__long___2IkRvzyG2K]: hasVariant(
                variants,
                "long",
                "long"
              )
        ...
        >
          <div
            className={classNames(
              ...
              sty.freeBox__grWaj,
              {
                [sty.freeBox__long__grWajzyG2K]: hasVariant(
                  variants,
                  "long",
                  "long"
                )
      ...
      <p.Stack
        ...
        className={classNames(
          ...
          sty.freeBox__hr6Rj,
          {
            [sty.freeBox__long__hr6RJzyG2K]: hasVariant(
              variants,
              "long",
              "long"
            )
      ...
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(
            ...
            sty.freeBox__mmEu5,
            {
              [sty.freeBox__long__mmEu5ZyG2K]: hasVariant(
                variants,
                "long",
                "long"
              )
